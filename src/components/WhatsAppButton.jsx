...
/**
 * WhatsAppButton
 * Opens a WhatsApp chat to +91 7400440127 using wa.me deep link.
 *
 * Props:
 * - message?: string            // Prefilled message in the chat
 * - label?: string              // Visible button label (optional)
 * - size?: "sm" | "md" | "lg"   // Button size
 * - floating?: boolean          // If true, shows a fixed floating button (bottom-right)
 * - className?: string          // Extra classNames to style/override
 */
const WhatsAppButton = ({
  ...
  // WhatsApp requires numeric international format without the '+' sign
  const phoneDigits = "917400440127";
  ...
  // Floating style (glassmorphism + glow)
