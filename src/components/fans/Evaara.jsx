...
const Evaara = () => {
  ...
  bg-[length:200%_200%] animate-[gradient-move_8s_ease_infinite] text-black min-h-screen flex flex-col lg:flex-row items-center justify-center w-full overflow-hidden py-8 lg:py-16">
      {/* Fan Image */}
      <motion.div
      ...
      >
        <img
          src="/fan 3d/Evaara/brown-4/2.webp"
          alt="Evaara Fan"
      ...
      >
        {/* Fan Name */}
       <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-pacifico"><span className="text-green-400">e</span>Vaara</h1>
