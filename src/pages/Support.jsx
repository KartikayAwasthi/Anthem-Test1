...
const ServiceGrid = lazy(() => import("../components/support/ServiceGrid"));
const WarrentyTechnicalInfo = lazy(() => import("../components/support/WarrentyTechnicalInfo"));
